...
const Lesson6-DrugsandAddictionAssessment = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg p-8">
        <h1 className="text-3xl font-bold mb-4">Lesson 6 - Drugs and Addiction Assessment</h1>
...
export default Lesson6-DrugsandAddictionAssessment;