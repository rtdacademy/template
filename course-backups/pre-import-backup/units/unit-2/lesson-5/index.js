...
const PreparingaResumeandCoverLetter = () => {
  return (
    <div className="space-y-8">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-lg p-8">
        <h1 className="text-3xl font-bold mb-4">Preparing a Resume and Cover Letter</h1>
...
export default PreparingaResumeandCoverLetter;