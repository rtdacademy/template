...
const Lesson18-InvestingandInsuranceAssessment = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg p-8">
        <h1 className="text-3xl font-bold mb-4">Lesson 18 - Investing and Insurance Assessment</h1>
...
export default Lesson18-InvestingandInsuranceAssessment;