...
const Lesson14-FinancialLiteracyAssessment = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg p-8">
        <h1 className="text-3xl font-bold mb-4">Lesson 14 - Financial Literacy Assessment</h1>
...
export default Lesson14-FinancialLiteracyAssessment;